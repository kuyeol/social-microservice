...
import org.account.util.SessionUtil;
...
public class ErrorResponseException extends WebApplicationException {
    ...
    public Response getResponse() {
       Session session = SessionUtil.getKeycloakSession();
        if (session != null) {
        ...
        if (response != null) {
            ...
            return Response.status(status).entity("RESPONSE ERROR").type(MediaType.APPLICATION_JSON_TYPE).build();
        }
    }
