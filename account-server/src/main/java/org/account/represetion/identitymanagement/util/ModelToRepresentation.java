...
import org.acme.account.model.UserSessionModel;
...
public class ModelToRepresentation {
    ...
    public static UserRepresentation toRepresentation( KeycloakSession session, UserModel user) {
