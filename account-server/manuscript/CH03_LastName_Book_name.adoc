...
This code is shown in listing <<ch3-listing-XYZ-1>>.


//code listing
[#ch3-listing-XYZ-1, reftext={chapter}.{counter:listing}]
.Listing title
[source,java]
----
code code code <1>
...
And the code shown in listing <<ch3-listing-XYZ-2>> explains ...

//code listing
[id="ch3-listing-XYZ-2", reftext={chapter}.{counter:listing}]
...
[#ch3-figure-XYZ-1, reftext={chapter}.{counter:figure}]
.Figure 1
image::../images/ch03/CH03_F01_LastName.png[,600]

This is a reference for figure <<ch3-figure-XYZ-1>>.



[#ch3-figure-XYZ-2, reftext={chapter}.{counter:figure}]
.Figure 1
image::../images/ch03/CH03_F02_LastName.png[,600]

This is a reference for figure <<ch3-figure-XYZ-2>>.


This is a reference for table <<ch3-table-XYZ-1>>.


[#ch3-table-XYZ-1, reftext={chapter}.{counter:table}]
