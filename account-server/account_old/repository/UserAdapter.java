...
import org.account.entites.UserRoleMappingEntity;
import org.account.service.RoleModel;
import org.account.service.SubjectCredentialManager;
import org.account.service.UserModel;
import org.account.util.ModelUtil;
import org.account.util.MultivaluedHashMap;
import org.account.util.ObjectUtil;
...
public class UserAdapter implements UserModel, JpaModel<UserEntity> {
    ...
    public void setUsername(String username) {
        username = ModelUtil.toLowerCaseSafe( username);
    ...
    private void persistAttributeValue(String name, String value) {
        ...
        attr.setId(ModelUtil.generateId());
        attr.setName(name);
        attr.setValue(value);
        attr.setUser(user);
        em.persist(attr);
    ...
    public void setEmail(String email) {
        ...
        email = ModelUtil.toLowerCaseSafe(email);
