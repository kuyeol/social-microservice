...
import org.acme.security.util.PemUtil;
...
public class RSAPublicJWK extends JWK {
    ...
    public void setX509CertificateChain(String[] x509CertificateChain) {
        ...
        if (x509CertificateChain != null && x509CertificateChain.length > 0) {
            try {
                sha1x509Thumbprint = PemUtil.generateThumbprint(x509CertificateChain, "SHA-1");
                sha256x509Thumbprint = PemUtil.generateThumbprint(x509CertificateChain, "SHA-256");
