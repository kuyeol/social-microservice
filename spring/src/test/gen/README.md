...
spring API
- API version: 1.0.0
  - Build date: 2025-02-22T17:36:41.588696094+09:00[Asia/Seoul]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**getNewsByID**](docs/DefaultApi.md#getNewsByID) | **GET** /android/news{id} | GET android/news{id}
