...
public abstract class HystrixCommandProperties
{
  ...
  protected HystrixCommandProperties(CommandKey key , Setter builder , String propertyPrefix)
  {
    ...
    this.executionIsolationThreadInterruptOnFutureCancel  = getProperty( propertyPrefix ,
                                                                         key ,
  ...
  private static Property<Boolean> getProperty(String propertyPrefix , CommandKey key ,
                                               String instanceProperty ,
                                               Boolean builderOverrideValue , Boolean defaultValue)
  {
    return forBoolean().add( propertyPrefix + ".command." + key.name() + "." + instanceProperty ,
                             builderOverrideValue )
                       .add( propertyPrefix + ".command.default." + instanceProperty ,
                             defaultValue )
                       .build();
  }


  private static Property<Integer> getProperty(String propertyPrefix , CommandKey key ,
                                               String instanceProperty ,
                                               Integer builderOverrideValue , Integer defaultValue)
  {
    return forInteger().add( propertyPrefix + ".command." + key.name() + "." + instanceProperty ,
                             builderOverrideValue )
                       .add( propertyPrefix + ".command.default." + instanceProperty ,
                             defaultValue )
                       .build();
  ...
  @SuppressWarnings( "unused" )
  private static Property<String> getProperty(String propertyPrefix , CommandKey key ,
                                              String instanceProperty ,
                                              String builderOverrideValue , String defaultValue)
  {
    return forString().add( propertyPrefix + ".command." + key.name() + "." + instanceProperty ,
                            builderOverrideValue )
  ...
  private static Property<ExecutionIsolationStrategy> getProperty(final String propertyPrefix ,
  ...
  {
    return new ExecutionIsolationStrategyHystrixProperty( builderOverrideValue ,
                                                          key ,
                                                          propertyPrefix ,
                                                          defaultValue ,
                                                          instanceProperty );
  ...
  private static final class ExecutionIsolationStrategyHystrixProperty
    implements Property<ExecutionIsolationStrategy>
  {
    ...
    private ExecutionIsolationStrategyHystrixProperty(
      ExecutionIsolationStrategy builderOverrideValue , CommandKey key , String propertyPrefix ,
      ExecutionIsolationStrategy defaultValue , String instanceProperty)
    {
      ...
      property = forString().add(
                              propertyPrefix + ".command." + key.name() + "." + instanceProperty , overrideValue )
                            .add( propertyPrefix + ".command.default." + instanceProperty ,
                                  defaultValue.name() )
                            .build();
    ...
    private void parseProperty()
    {
      try {
        ...
        logger.error(
          "Unable to derive ExecutionIsolationStrategy from property value: " + property.get() ,
          e );
  ...
  /**
   * Factory method to retrieve the default Setter. Groovy has a bug (GROOVY-6286) which does not
   * allow method names and inner classes to have the same name This method fixes Issue #967 and
   * allows Groovy consumers to choose this method and not trigger the bug
   */
  ...
  public static class Setter
  {
    ...
    /**
     * @deprecated As of 1.4.0, replaced with {@link #withExecutionTimeoutInMilliseconds(int)}.
     * Timeouts are no longer applied only to thread-isolated commands, so a thread-specific name is
     * misleading
     */
    @Deprecated
