...
public interface Pool
{
    ...
    /* package */static class Factory {
        ...
        /* package */static Pool getInstance(PoolKey threadPoolKey, ThreadPoolProperties.Setter propertiesBuilder) {
        ...
        /**
         * Initiate the shutdown of all {@link Pool} instances and wait up to the given time on each pool to complete.
         * <p>
         * NOTE: This is NOT thread-safe if HystrixCommands are concurrently being executed
         * and causing thread-pools to initialize while also trying to shutdown.
         * </p>
    ...
    /* package */static class HystrixThreadPoolDefault implements Pool {
        ...
        public HystrixThreadPoolDefault(PoolKey threadPoolKey, ThreadPoolProperties.Setter propertiesDefaults) {

            this.properties = PropertiesFactory.getThreadPoolProperties(threadPoolKey, propertiesDefaults);
        ...
        private void touchConfig() {
            ...
            if (threadPool.getCorePoolSize() != dynamicCoreSize || (allowSizesToDiverge && threadPool.getMaximumPoolSize() != dynamicMaximumSize)) {
                if (maxTooLow) {
                    logger.error("Hystrix ThreadPool configuration for : " +"getThreadPoolKey().name()" + " is trying to set coreSize = " +
