...
/**
 * Sample HystrixCommand simulating one that would fetch UserAccount objects from a remote service
 * or database.
 * <p>
 * This uses request caching and fallback behavior.
 */
public class GetUserAccountCommand extends Command<UserAccount>
{
    ...
    protected GetUserAccountCommand(HttpCookie cookie)
    {
        super(setter);
    ...
    private static class UserCookie
    {
         ...
         * @return UserCookie
         *
         * @throws IllegalArgumentException if cookie is invalid
         */
